...
class DictionarySettingsWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        dict_layout.setVerticalSpacing(14)
        dict_layout.setColumnStretch(1, 2)
        dict_layout.setColumnMinimumWidth(0, 110)

        dict_layout.setContentsMargins(0, 24, 0, 0)
        ...
        dic_label = QLabel("カスタム辞書 (dicrc):")
        apply_label_style(dic_label)
        dic_label.setAlignment(Qt.AlignLeft | Qt.AlignVCenter)
        dict_layout.addWidget(dic_label, 1, 0, alignment=Qt.AlignVCenter)
        ...
        user_dict_label = QLabel("ユーザー辞書 (.dic):")
        apply_label_style(user_dict_label)
        user_dict_label.setAlignment(Qt.AlignLeft | Qt.AlignVCenter)
        dict_layout.addWidget(user_dict_label, 2, 0, alignment=Qt.AlignVCenter)
        ...
        dict_layout.setRowMinimumHeight(1, 32)
        dict_layout.setRowMinimumHeight(2, 32)
